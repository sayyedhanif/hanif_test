...
module.exports = function(){
    ...
    this.id = "triggerapp-projects-get";
    this.label = "Get Project List";
    this.input = {
    ...
    this.help = "Returns all projects of current account.";
    ...
    this.execute = function(input, output) {
        ...
        request({
            method :'GET',           
            url: "https://www.triggerapp.com/api/v1/projects?token="+input.token+"&api_key="+input.api_key
