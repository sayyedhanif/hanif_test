...
module.exports = function(){
    ...
    this.id = "jive-place-spaces-get";
    this.label = "Get Spaces";
    this.input = {
        "title": "Get Spaces",
        "type": "object",
        "properties": {
            ...
            "startIndex": {
                ...
                "description": "Enter the starting index value of spaces data array, default index value is zero",
                "default": '0'
            }
        }
    };

    this.help = "Service to get all place of type spaces in Jive portal";
    ...
    this.execute = function(input, output) {
        ...
        request({
            ...
            url: input.site_url+ "/api/core/v3/places?filter=type(space)&count="+input.itemsPerPage+"&startIndex="+ input.startIndex,
            auth: {
